...
echo "
		...
		<div style='padding-top:0px;font-size:11px;'>
		
			<div style='float:left;font-size:". $textsize. ";'>( " . $amount ." Items, ". $CURRENCY_DISPLAY->getFullValue($total) ." ) </div>
		<!--
             <a href='" .$sess->url($mm_action_url."index.php?page=shop.cart")."' style='text-decoration:none;'>
				 &nbsp; View Cart |
				-->
 ...
 if ($amount >= 1) 		
	if ($imageortext == "0") { 
echo "<img src='". $buttonimage. "' alt='Check Out' border='0' style='padding-bottom:10px;'/>";
} else {
echo "<span style='font-size:". $textsize. ";'><strong>". $buttontext.  "</span><br/><br/>";
 }
