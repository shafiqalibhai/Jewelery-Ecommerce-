...
define( 'URL', 'http://www.cindylackore.com/' );
define( 'SECUREURL', 'http://www.cindylackore.com/' );
...
define('DOWNLOADROOT', '/home/content/o/k/2/ok2rest/html/');
...
define('CHECK_STOCK', '');
define('ENCODE_KEY', '59d7921b6160b2780a1b1cde17b03062');
define('NO_SHIPPING', '');
define('NO_SHIPTO', '');
...
$VM_BROWSE_ORDERBY_FIELDS = array( 'product_list','product_name','product_price','product_cdate','product_sku' );
