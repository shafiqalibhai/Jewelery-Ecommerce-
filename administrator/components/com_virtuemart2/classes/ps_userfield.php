...
echo '<div style="width:100%; background:#FFFFFF; background-color:#FFFFFF; color:#000000;">';
		...
		echo '
		<div style="width:100%;background:#FFFFFF; background-color:#FFFFFF; color:#000000;">';
			
		if( !empty( $required_fields ))  {
			echo '<div style="padding:5px;text-align:left;"><div style=" color:#50AEE6; font-size:15px;"><strong>Welcome, Please Sign In</strong></div>
			<br><br>
			<b>New Customer</b>
			<br>
			I am new customer.
			...
			<tr><td align="justify">
			By creating and account at Sharpics you will be able to shop faster, be up to date on an orders status, and keep track of the orders you have previously made.
			</td></tr>
			</table>
			
			<br><br>
			<div style="color:red;"> * Required Information </div>
			</div>';
...
';
	   		...
	   		echo '<div style="text-align:left; padding-left:10px;" id="'.$field->name.'_div" class="formLabel ';
