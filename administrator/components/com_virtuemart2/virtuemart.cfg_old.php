...
define( 'URL', 'http://localhost/remodel-2/' );
define( 'SECUREURL', 'http://localhost/remodel-2/' );

if ( (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') || $_SERVER['SERVER_PORT'] == '443' ) {
	define( 'IMAGEURL', SECUREURL .'components/com_virtuemart/shop_image/' );
	define( 'VM_THEMEURL', SECUREURL.'components/com_virtuemart/themes/vm_black/' );
} else {
	define( 'IMAGEURL', URL .'components/com_virtuemart/shop_image/' );
	define( 'VM_THEMEURL', URL.'components/com_virtuemart/themes/vm_black/' );
}
define( 'VM_THEMEPATH', $mosConfig_absolute_path.'/components/com_virtuemart/themes/vm_black/' );
...
define('DOWNLOADROOT', 'C:\wamp\www\remodel-2/');
...
define('ENCODE_KEY', 'edaa7bebd6058ea2141b01a51951a387');
define('NO_SHIPPING', '');
define('NO_SHIPTO', '');
...
define('VM_FEED_DESCRIPTION_TYPE', 'product_desc');
