...
DEFINE("_DM_TITLE","Empfehle unsere Seite deinen Freunden!");

/////////////////////// For Logged in Users Only
DEFINE("_DM_USER_INSTRUCTIONS","
<br />
Dein Name und deine Email-Adresse wird in den Emails an deine Freunde enthalten sein. Du kannst diese Felder nicht verändern!
<br /><br />
&nbsp;&nbsp;- Du musst zumindest <b>1</b> Email eines Freundes angeben.
<br />");

/////////////////////// For Public Users - Anyone can send an invite/recommendation
DEFINE("_DM_USER_INSTRUCTIONS_1","
<br />
Der Name und die Email Adresse, die du in den Feldern unten eingibst wird in den Emails an deine Freunde enthalten sein.
<br /><br />
&nbsp;&nbsp;- Du musst <b>deine</b> Email eingeben
<br />
&nbsp;&nbsp;- Du musst zumindest <b>1</b> Email eines Freundes eingeben
<br />");

/////////////////////// Captch Instructions - If Option Selected in Admin
DEFINE("_DM_USER_INSTRUCTIONS_CAPTCHA","
&nbsp;&nbsp;- Du musst den korrekten Sicherheits-Code eingeben.
<br />");

/////////////////////// Thank You Note
DEFINE("_DM_USER_INSTRUCTIONS_THANKS","
<br />
Felder mit <font color='red'><b>**</b></font> müssen korrekt ausgefüllt werden, um die Einladungen zu schicken.
<br /><br />
Danke für die Empfehlungen!
<br />");

/////////////////////// Frontend Email Form Display
DEFINE("_DM_YOUR_NAME","Dein Name:");
DEFINE("_DM_YOUR_EMAIL","Deine E-mail:");
DEFINE("_DM_FRIEND1_NAME","Name des Freundes (optional):");
DEFINE("_DM_FRIEND1_EMAIL","E-mails des/der Freunde(s):");
DEFINE("_DM_MESSAGE","Persönliche Nachricht (optional):");
DEFINE("_DM_MESSAGE_HTML","Die Site Administrator hat aktiviert HTML-Code für Ihre persönliche Nachricht. Wenn Sie HTML-Code verwenden, stellen Sie bitte sicher, dass Sie völlig korrekte HTML-Syntax - auch im Online-Stilen und &lt;p&gt;Text&lt;/p&gt; oder &lt;br /&gt; für alle Zeilenumbrüche, da sonst die E-Mails werden nicht korrekt angezeigt oder kann abgelehnt werden, von den Empfängern!");
DEFINE("_DM_SEND","Empfehlung versenden!");

DEFINE("_DM_CC_USER","Willst du eine Kopie (Bcc)der Email?");

/////////////////////// Javascript/Captcha Form Validation Alert Errors
DEFINE("_DM_ALERT_FROM_EMAIL_EMPTY","Deine Email Adresse fehlt...");
DEFINE("_DM_ALERT_TO_EMAIL_EMPTY","Du musst zumindest 1 Email Adresse angeben zu der die Einladung geschickt werden soll...");
DEFINE("_DM_ALERT_FROM_EMAIL_INVALID","Bitte stelle sicher, dass deine Email gültig ist (z.B. friend@home.com)...");
DEFINE("_DM_ALERT_TO_EMAIL_INVALID","Bitte stelle sicher, dass die Emails deiner Freunde alle gültig sind (z.B. friend@home.com)...");
DEFINE("_DM_ALERT_MULTIPLE_EMAIL"," *** Du darfst nur eine Email pro Feld eingeben *** ");
DEFINE("_DM_CAPTCHA_INFO1","Anti-Spam Sicherheits Check - Gib den Sicherheitscode ein, der im Feld steht:");
DEFINE("_DM_CAPTCHA_INFO2","Aktualisieren");
DEFINE("_DM_CAPTCHA_INFO3","Klicken Sie auf 'Aktualisieren', wenn Sie nicht lesen kann der Sicherheitsrat Image");
DEFINE("_DM_CAPTCHA_INFO4","Sicherheits-Code:");
DEFINE("_DM_CAPTCHA_ALERT","*** Du hast einen ungültigen Sicherheits-Code eingegeben... Bitte versuch es nochmal ***");
DEFINE("_DM_CAP_REFRESH_ALERT","Ein Klick auf 'OK' löscht alle Informationen auf dem Formular! Continue anyway?");

/////////////////////// Email Success/Fail Messages
DEFINE("_DM_SUCCESS"," Email(s) ist/sind erfolgreich geschickt worden!");
DEFINE("_DM_SUCCESS_LIST","Hier ist die Liste der Emails an die verschickt wurde:");
DEFINE("_DM_THANK_YOU","Danke dass du uns weiterempfohlen hast!");
DEFINE("_DM_FAIL"," Email(s) konnten gerade nicht gesendet werden.  Bitte versuch es später noch einmal.");
DEFINE("_DM_FAIL_LIST","Hier ist die Liste der nicht gesendeten Emails:");
DEFINE("_DM_COPY_USER","Danke für die Weiterempfehlung ");
DEFINE("_DM_COPY_USER1","Hier ist eine Liste der Namen und Emails an die du verschickt hast:");
DEFINE("_DM_COPY_USER2","Hier ist eine Kopie der Email die deine Freunde erhalten werden:");
DEFINE("_DM_YOUR_COPY1","Ihr Email Copy (Bcc): ");
DEFINE("_DM_RECOMMEND_USER1","Weiterempfehlen User Info: ");
DEFINE("_DM_RECOMMEND_USER2","Weiterempfehlen Benutzernamen und E-Mail-Adresse: ");
DEFINE("_DM_BACK","Zurück");

/////////////////////// E-mail Sent to Friends Variables
DEFINE("_DM_HELLO","Hi du! ");  //introduction in the body of the email if friends name is provided
DEFINE("_DM_HELLO_2", "Hi du!"); //introduction in the body of the email if friends name not provided
DEFINE("_DM_FRIEND","Dein Freund "); //used in the SUBJECT of the email (if not defined by admin) followed by username and email
DEFINE("_DM_FRIEND_2","Ein Freund von dir, ");  //starting line in the body of the email followed by username and email
DEFINE("_DM_INVITES_YOU"," möchte dass du dir mal die folgende Weebsite anschaust ");  //follows _DM_FRIEND
DEFINE("_DM_INVITES_YOU_2","meint, dass dich diese super Website interessieren könnte ");  //  follows _DM_FRIEND_2
DEFINE("_DM_GO_TO","Sieh dir die Website unter der folgenden Adresse an:");  //middle of email body where your site link actualy appears
DEFINE("_DM_TELLS_YOU","'s persönliche Nachricht an dich:");  //message if user filled in message field
DEFINE("_DM_FRIEND_TELLS_YOU","Your Friend's persönliche Nachricht an Sie:");  //message if user filled in message field
DEFINE("_DM_ADMIN_NEWS","Great News!");
DEFINE("_DM_ADMIN_COPY"," wurde gerade von einem Nutzer seinen Freunden empfohlen!");
DEFINE("_DM_ADMIN_COPY1","Hier ist eine Liste der Freunde, an die die Email verschickt wurde:");
DEFINE("_DM_ADMIN_COPY2","Hier ist eine Kopie der Email, die verschickt wurde:");
...
DEFINE("_DM_PREVIEW_USER_MESSAGE_INFO","<b><i>Users Username's</i></b>'s peronal message to you:");
