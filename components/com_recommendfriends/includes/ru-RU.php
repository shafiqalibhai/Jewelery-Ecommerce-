...
DEFINE("_DM_TITLE","Рекоммендуй наш сайт друзьям!");

/////////////////////// For Logged in Users Only
DEFINE("_DM_USER_INSTRUCTIONS","
<br />
Ваше имя и адрес электронной почты, указанные ниже, будут содержаться в письмах высланных Вашим друзьям.  Замечание: Вы не имеете возможности редактировать эти поля!!
<br /><br />
&nbsp;&nbsp;- Вы должны ввести хотя бы <b>1</b> адрес Вашего друга
<br />");

/////////////////////// For Public Users - Anyone can send an invite/recommendation
DEFINE("_DM_USER_INSTRUCTIONS_1","
<br />
Ваше имя и адрес электронной почты, указанные ниже, будут содержаться в письмах высланных Вашим друзьям.
<br /><br />
&nbsp;&nbsp;- Вы должны ввести <b>your</b> адрес электронной почты
<br />
&nbsp;&nbsp;- Вы должны ввести хотя бы <b>1</b> адрес Вашего друга
<br />");
...
<br />
Поля, выделенные <font color='red'><b>**</b></font> должны быть правильно заполнены для рекоммендации сайта.
<br /><br />
Спасибо за то, что рекоммендуете нас!
<br />");

/////////////////////// Frontend Email Form Display
DEFINE("_DM_YOUR_NAME","Ваше имя:");
DEFINE("_DM_YOUR_EMAIL","Ваш адрес электронной почты:");
DEFINE("_DM_FRIEND1_NAME","Имя друга (необязательно):");
DEFINE("_DM_FRIEND1_EMAIL","Адрес электронной почты друга:");
DEFINE("_DM_MESSAGE","Ваше личное сообщение (необязательно):");
DEFINE("_DM_MESSAGE_HTML","The site administrator has enabled HTML code for your personal message. If you do use HTML code, please ensure that you use completely correct HTML syntax - including in-line styles and &lt;p&gt;text&lt;/p&gt; or &lt;br&gt; for all line breaks, otherwise the emails will not appear correctly or may be rejected by the recipients!");
DEFINE("_DM_CC_USER","Обозначьте, если желаете получить копию (Bcc) электронного письма");

/////////////////////// Javascript/Captcha Form Validation Alert Errors
DEFINE("_DM_ALERT_FROM_EMAIL_EMPTY","Вы должны ввести свой адрес электронной почты...");
DEFINE("_DM_ALERT_TO_EMAIL_EMPTY","Вы должны ввести хотя бы один адрес электронной почты друга...");
DEFINE("_DM_ALERT_FROM_EMAIL_INVALID","Удостоверьтесь, пожалуйста, что Вы правильно записали адрес электронной почты (т.е. friend@home.com)...");
DEFINE("_DM_ALERT_TO_EMAIL_INVALID","Удостоверьтесь, пожалуйста, что Вы правильно записали все адреса электронной почты друзей (т.е. friend@home.com)...");
DEFINE("_DM_ALERT_MULTIPLE_EMAIL"," *** Вы можете вписать только ОДИН адрес электронной почты в одно поле *** ");
DEFINE("_DM_CAPTCHA_INFO1","Anti-Spam защитная проверка - Введите указанный защитный код:");
DEFINE("_DM_CAPTCHA_INFO2","Reload");
DEFINE("_DM_CAPTCHA_INFO3","Click 'Reload' if you can't read the Security Image");
DEFINE("_DM_CAPTCHA_INFO4","Защитный код:");
DEFINE("_DM_CAPTCHA_ALERT","*** Вы ввели неправильный защитный код... Попытайтесь снова ***");
DEFINE("_DM_CAP_REFRESH_ALERT","Clicking Okay will erase ALL information on the form!  Continue Anyway?");

/////////////////////// Email Success/Fail Messages
DEFINE("_DM_SUCCESS"," электронное(ые) письмо(а) были успешно высланы!");
DEFINE("_DM_SUCCESS_LIST","Это список адресов по которым были успешно высланы электронное(ые) письмо(а):");
DEFINE("_DM_THANK_YOU","Спасибо за то, что рекоммендуете нас!");
DEFINE("_DM_FAIL"," электронное(ые) письмо(а) не были высланы.  Попытайтесь выслать позже.");
DEFINE("_DM_FAIL_LIST","Это список адресов которым не были высланы электронное(ые) письмо(а):");
DEFINE("_DM_COPY_USER","Спасибо за то, что рекоммендуете нас! ");
DEFINE("_DM_COPY_USER1","Это список имен и адресов по которым были высланы электронное(ые) письмо(а):");
DEFINE("_DM_COPY_USER2","Это копия электронного письма, которое получат Ваши друзья:");
DEFINE("_DM_YOUR_COPY1","Your Email (Bcc) Copy: ");
DEFINE("_DM_RECOMMEND_USER1","Recommending User Info: ");
DEFINE("_DM_RECOMMEND_USER2","Recommending User Name and Email: ");
DEFINE("_DM_BACK","Назад");

/////////////////////// E-mail Sent to Friends Variables
DEFINE("_DM_HELLO","Привет ");  //introduction in the body of the email if friends name is provided
DEFINE("_DM_HELLO_2", "Привет!"); //introduction in the body of the email if friends name not provided
DEFINE("_DM_FRIEND","Ваш друг "); //used in the SUBJECT of the email (if not defined by admin) followed by username and email
DEFINE("_DM_FRIEND_2","Ваш друг, ");  //starting line in the body of the email followed by username and email
DEFINE("_DM_INVITES_YOU"," прелагает Вам посетить ");  //follows _DM_FRIEND
DEFINE("_DM_INVITES_YOU_2","думает, что Вам очень понравится этот сайт - ");  //  follows _DM_FRIEND_2
DEFINE("_DM_GO_TO","Посетите сайт по адресу:");  //middle of email body where your site link actualy appears
DEFINE("_DM_TELLS_YOU","'s личное сообщение вам:");  //message if user filled in message field

DEFINE("_DM_FRIEND_TELLS_YOU","?????? ????? ?????? ????????? ? ???:");  //message if user filled in message field

DEFINE("_DM_ADMIN_NEWS","??????? ???????!");

DEFINE("_DM_ADMIN_COPY"," был только что рекомендован пользователем своему(им) другу(зьям)!");
DEFINE("_DM_ADMIN_COPY1","Это список его друзей, которым были высланы электронное(ые) письмо(а):");
DEFINE("_DM_ADMIN_COPY2","Это копия электронного письма, которое было выслано:");
