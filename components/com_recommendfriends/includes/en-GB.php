...
DEFINE("_DM_TITLE","Recommend Our Site to Your Friends!");

/////////////////////// For Logged in Users Only
DEFINE("_DM_USER_INSTRUCTIONS","
<br />
Your name and email address, shown below, will appear in the emails you send to your friends.  Note: You can't edit these fields!!
<br /><br />
&nbsp;&nbsp;- You must enter at least <b>1</b> of your Friend's email address
<br />");
...
<br /><br />
&nbsp;&nbsp;- You must enter <b>your</b> email address
<br />
&nbsp;&nbsp;- You must enter at least <b>1</b> of your Friend's email address
<br />");
...
<br />
Fields marked with <font color='red'><b>**</b></font> must be completed correctly in order to send the site recommendation.
<br /><br />
Thanks for recommending us!
<br />");

/////////////////////// Frontend Email Form Display
DEFINE("_DM_YOUR_NAME","Your Name:");
DEFINE("_DM_YOUR_EMAIL","Your E-mail:");
DEFINE("_DM_FRIEND1_NAME","Friend's Names (optional):");
DEFINE("_DM_FRIEND1_EMAIL","Friend's E-mails:");
DEFINE("_DM_MESSAGE","Your Personal Message (optional):");
...
DEFINE("_DM_SEND","Send Recommendation!");
DEFINE("_DM_CC_USER","Check if you would like a copy(Bcc) of the email");

/////////////////////// Javascript/Captcha Form Validation Alert Errors
DEFINE("_DM_ALERT_FROM_EMAIL_EMPTY","You need to enter your email address...");
DEFINE("_DM_ALERT_TO_EMAIL_EMPTY","You need to enter at least 1 email address to send to...");
DEFINE("_DM_ALERT_FROM_EMAIL_INVALID","Please make sure your email address is valid (ie. friend@home.com)...");
DEFINE("_DM_ALERT_TO_EMAIL_INVALID","Please make sure all your Friends emails are valid (ie. friend@home.com)...");
DEFINE("_DM_ALERT_MULTIPLE_EMAIL"," *** You are only allowed to enter ONE email address per field *** ");
DEFINE("_DM_CAPTCHA_INFO1","Anti-Spam Security Check - Enter the security code shown in the field provided:");
DEFINE("_DM_CAPTCHA_INFO2","Reload");
DEFINE("_DM_CAPTCHA_INFO3","Click 'Reload' if you can't read the Security Image");
DEFINE("_DM_CAPTCHA_INFO4","Security Code:");
DEFINE("_DM_CAPTCHA_ALERT","*** You have entered an invalid Security Code... Please try again ***");
...
DEFINE("_DM_SUCCESS"," email(s) have been successfully sent!");
DEFINE("_DM_SUCCESS_LIST","Here is a list of the emails that were sent:");
DEFINE("_DM_THANK_YOU","Thank You for Recommending Us!");
DEFINE("_DM_FAIL"," email(s) could NOT be sent at this time.  Please try again later.");
DEFINE("_DM_FAIL_LIST","Here is a list of the emails that were not sent:");
DEFINE("_DM_COPY_USER","Thanks for Recommending Our Site: ");
DEFINE("_DM_COPY_USER1","Here is a list of the name(s) and email address(es) you sent:");
DEFINE("_DM_COPY_USER2","Here is a copy of the email that your Friends will receive:");
...
DEFINE("_DM_HELLO","Hey there ");  //introduction in the body of the email if friends name is provided
DEFINE("_DM_HELLO_2", "Hey there!"); //introduction in the body of the email if friends name not provided
DEFINE("_DM_FRIEND","Your Friend "); //used in the SUBJECT of the email (if not defined by admin) followed by username and email
DEFINE("_DM_FRIEND_2","A friend of yours, ");  //starting line in the body of the email followed by username and email
DEFINE("_DM_INVITES_YOU","wants you to check out ");  //follows _DM_FRIEND in the SUBJECT of the email
DEFINE("_DM_INVITES_YOU_2","thinks you would be quite interested in this great site - ");  //  follows _DM_FRIEND_2
DEFINE("_DM_GO_TO","Check out the site at:");  //middle of email body where your site link actualy appears
DEFINE("_DM_TELLS_YOU","'s personal message to you:");  //message if user filled in message field
DEFINE("_DM_FRIEND_TELLS_YOU","Your Friend's personal message to you:");  //message if user filled in message field
DEFINE("_DM_ADMIN_NEWS","Great News!");
DEFINE("_DM_ADMIN_COPY"," has just been recommended by a user to their Friend(s)!");
DEFINE("_DM_ADMIN_COPY1","Here is a list of Friend(s) the email was sent to:");
DEFINE("_DM_ADMIN_COPY2","Here is a copy of the email that was sent:");
